...
# Hand-build the YouTube Home Reload Safari app + web-extension appex with
...
APP="$BUILD/YouTubeHomeReload.app"
APPEX="$APP/Contents/PlugIns/YouTubeHomeReload Extension.appex"
...
swiftc -parse-as-library -application-extension \
  ...
  -module-name YouTubeHomeReload_Extension \
  "$ROOT/app/SafariWebExtensionHandler.swift" \
  -framework SafariServices \
  -Xlinker -e -Xlinker _NSExtensionMain \
  -o "$APPEX/Contents/MacOS/YouTubeHomeReload Extension"
...
<plist version="1.0">
<dict>
	<key>CFBundleDisplayName</key><string>YouTube Home Reload</string>
	<key>CFBundleExecutable</key><string>YouTubeHomeReload Extension</string>
	<key>CFBundleIdentifier</key><string>dev.ivogundlach.YouTubeHomeReload.Extension</string>
	<key>CFBundleInfoDictionaryVersion</key><string>6.0</string>
	<key>CFBundleName</key><string>YouTubeHomeReload Extension</string>
	...
	<dict>
		...
		<key>NSExtensionPrincipalClass</key><string>YouTubeHomeReload_Extension.SafariWebExtensionHandler</string>
	</dict>
</dict>
</plist>
PLIST
...
swiftc -parse-as-library \
  ...
  -o "$APP/Contents/MacOS/YouTubeHomeReload"
...
<plist version="1.0">
<dict>
	<key>CFBundleExecutable</key><string>YouTubeHomeReload</string>
	<key>CFBundleIconFile</key><string>AppIcon</string>
	<key>CFBundleIdentifier</key><string>dev.ivogundlach.YouTubeHomeReload</string>
	<key>CFBundleInfoDictionaryVersion</key><string>6.0</string>
	<key>CFBundleName</key><string>YouTube Home Reload</string>
...
if [ "${NO_DEPLOY:-0}" != "1" ]; then
  rm -rf "/Applications/YouTubeHomeReload.app"
  cp -R "$APP" /Applications/
  open "/Applications/YouTubeHomeReload.app"
  echo "Installed /Applications/YouTubeHomeReload.app"
fi
