...
name: gws-tasks
description: >-
  Use when Ivo asks to list, inspect, create, update, move, clear, or delete Google Tasks
  task lists or tasks. Trigger on Google Tasks, tasklist IDs, due tasks, completed task
  cleanup, task ordering, or task metadata. Read gws-shared first.
metadata:
  version: 0.22.5
  openclaw:
