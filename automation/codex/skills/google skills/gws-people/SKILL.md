...
name: gws-people
description: >-
  Use when Ivo asks to find, inspect, create, update, or delete Google contacts, contact
  groups, People profiles, directory people, or other contacts. Trigger on Google
  Contacts/People tasks, contact lookup, profile fields, phone/email lookup, or
  contact-group management. Read gws-shared first.
metadata:
  version: 0.22.5
  openclaw:
