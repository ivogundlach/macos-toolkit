...
description: Triage npm packages / dependency trees for supply-chain malware — typosquatting, dependency confusion, install-script backdoors, Shai-Hulud-class worms — with GuardDog, OSV, Semgrep, tarball inspection, and sandboxed detonation. Trigger on "is this npm package malicious", "audit my dependencies/node_modules", "GuardDog", "supply-chain scan". Defensive/authorized use only.
license: Apache-2.0
metadata:
