"""Host-supplied query planning with deterministic headless fallback."""
...
def plan_query(
    *,
    ...
    """Create a deterministic fallback plan when the host supplied no plan.
    ...
    # No --plan was passed. The deterministic fallback path is intentionally
    # weaker than a host-generated --plan. Surface this so
    ...
    # The engine never calls an external model for planning. LAW 7 / 2026-04-19
    ...
    if not internal_subrun:
        ...
        print(
            ...
            "via --plan. The engine does not call an external planning model. "
