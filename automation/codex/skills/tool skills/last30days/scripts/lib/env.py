...
KEYCHAIN_KEYS = (
    "OPENAI_API_KEY", "XAI_API_KEY", "SCRAPECREATORS_API_KEY", "APIFY_API_TOKEN",
...
def cookie_extraction_browsers(config: dict[str, Any]) -> list[str]:
    ...
    Default (FROM_BROWSER unset): Safari then Firefox on macOS, Firefox on
    other supported platforms. The Chromium family
    ...
    """
    silent_browsers = ["safari", "firefox"] if platform.system() == "Darwin" else ["firefox"]
